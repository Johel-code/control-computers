                ...
                <table class="md:table-fixed w-full font-anek">
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-blue-200">
                            <td wire:click="mostrarModalComputer({{ $product->id }})" class="cursor-pointer px-3 py-1 2xl:py-3 2xl:text-lg text-center text-ellipsis overflow-hidden border-b border-gray-400">
                                {{$product->id }}
                            </th>
                            <td wire:click="mostrarModalComputer({{ $product->id }})" class="cursor-pointer pr-3 py-1 2xl:text-lg text-center text-ellipsis md:overflow-hidden ms:overflow-hidden  border-b border-gray-400 whitespace-nowrap">
                                    {{ $product->serial }}
                            ...
                            <td wire:click="mostrarModalComputer({{ $product->id }})" class="cursor-pointer pr-3 py-1 2xl:text-lg text-center text-ellipsis overflow-hidden border-b border-gray-400">{{$product->marca }}</th>
                            <td wire:click="mostrarModalComputer({{ $product->id }})" class="cursor-pointer pr-3 py-1 2xl:text-lg text-center text-ellipsis overflow-hidden border-b border-gray-400">{{$product->state->name }}</th>
